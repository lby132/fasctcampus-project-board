...
public class ArticleCommentServiceTest {
    ...
    @Test
    void givenNonexistentArticle_whenSavingArticleComment_thenLogsSituationAndDoesNoting() throws Exception {
        //given
        ArticleCommentDto dto = createArticleCommentDto("댓글");
    ...
    @Test
    void givenNonexistentArticleComment_whenUpdatingArticleComment_thenLogsLogsWarningAndDoesNoting() throws Exception {
        //given
        ArticleCommentDto dto = createArticleCommentDto("댓글");
    ...
    private ArticleComment createArticleComment(String content) {
        return ArticleComment.of(
                Article.of(createUserAccount(), content, "title", "hashtag"),
                createUserAccount(),
                content
        );
    }
